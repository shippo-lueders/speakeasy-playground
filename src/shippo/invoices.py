...
class Invoices:
    ...
    def list_invoice_items_template(self, request: operations.ListInvoiceItemsTemplateRequest) -> operations.ListInvoiceItemsTemplateResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ListInvoiceItemsTemplateRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.ListInvoiceItemsTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
