...
class CarrierParcelTemplates:
    ...
    def list_carrier_parcel_templates(self, include: Optional[operations.Include] = None, carrier: Optional[str] = None, shippo_api_version: Optional[str] = None) -> operations.ListCarrierParcelTemplatesResponse:
        ...
        query_params = utils.get_query_params(operations.ListCarrierParcelTemplatesRequest, request)
        ...
        res = operations.ListCarrierParcelTemplatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_carrier_parcel_template(self, carrier_parcel_template_token: str, shippo_api_version: Optional[str] = None) -> operations.GetCarrierParcelTemplateResponse:
        ...
        res = operations.GetCarrierParcelTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
