...
class Parcels:
    ...
    def list_parcels(self, page: Optional[int] = None, results: Optional[int] = None, shippo_api_version: Optional[str] = None) -> operations.ListParcelsResponse:
        ...
        query_params = utils.get_query_params(operations.ListParcelsRequest, request)
        ...
        res = operations.ListParcelsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_parcel(self, shippo_api_version: Optional[str] = None, parcel_request: Optional[components.ParcelRequest] = None) -> operations.CreateParcelResponse:
        ...
        res = operations.CreateParcelResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_parcel(self, parcel_id: str, shippo_api_version: Optional[str] = None) -> operations.GetParcelResponse:
        ...
        res = operations.GetParcelResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
