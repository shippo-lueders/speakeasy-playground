...
class RatesAtCheckout:
    ...
    def create_live_rate(self, shippo_api_version: Optional[str] = None, live_rate_create_request: Optional[components.LiveRateCreateRequest] = None) -> operations.CreateLiveRateResponse:
        ...
        res = operations.CreateLiveRateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_default_parcel_template(self, shippo_api_version: Optional[str] = None) -> operations.GetDefaultParcelTemplateResponse:
        ...
        res = operations.GetDefaultParcelTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_default_parcel_template(self, shippo_api_version: Optional[str] = None, default_parcel_template_update_request: Optional[components.DefaultParcelTemplateUpdateRequest] = None) -> operations.UpdateDefaultParcelTemplateResponse:
        ...
        res = operations.UpdateDefaultParcelTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_default_parcel_template(self, shippo_api_version: Optional[str] = None) -> operations.DeleteDefaultParcelTemplateResponse:
        ...
        res = operations.DeleteDefaultParcelTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
