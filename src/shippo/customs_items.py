...
class CustomsItems:
    ...
    def list_customs_items(self, page: Optional[int] = None, results: Optional[int] = None, shippo_api_version: Optional[str] = None) -> operations.ListCustomsItemsResponse:
        ...
        query_params = utils.get_query_params(operations.ListCustomsItemsRequest, request)
        ...
        res = operations.ListCustomsItemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_customs_item(self, shippo_api_version: Optional[str] = None, customs_item_base: Optional[components.CustomsItemBase] = None) -> operations.CreateCustomsItemResponse:
        ...
        res = operations.CreateCustomsItemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_customs_item(self, customs_item_id: str, page: Optional[int] = None, shippo_api_version: Optional[str] = None) -> operations.GetCustomsItemResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetCustomsItemRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.GetCustomsItemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
