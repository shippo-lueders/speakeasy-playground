...
class ServiceGroups:
    ...
    def create_service_group(self, shippo_api_version: Optional[str] = None, service_group_create_request: Optional[components.ServiceGroupCreateRequest] = None) -> operations.CreateServiceGroupResponse:
        ...
        res = operations.CreateServiceGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_service_group(self, shippo_api_version: Optional[str] = None, service_group: Optional[components.ServiceGroup] = None) -> operations.UpdateServiceGroupResponse:
        ...
        res = operations.UpdateServiceGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_service_group(self, service_group_id: str, shippo_api_version: Optional[str] = None) -> operations.DeleteServiceGroupResponse:
        ...
        res = operations.DeleteServiceGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
