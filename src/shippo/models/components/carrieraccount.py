...
class CarrierAccount:
    ...
    r"""Name of the carrier (as a token).
    ...
    """
    parameters: Optional[UPSConnectExistingOwnAccountParameters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parameters'), 'exclude': lambda f: f is None }})
