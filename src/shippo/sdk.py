...
class Shippo:
    ...
    def example(self, header_param: Optional[str] = None, example_body: Optional[components.ExampleBody] = None) -> Union[components.ExampleOneResponse, components.ExampleTwoResponse]:
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(http_res.headers.get('Content-Type') or '', 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[Union[components.ExampleOneResponse, components.ExampleTwoResponse]])
                return out
