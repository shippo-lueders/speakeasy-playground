...
class Shippo:
    ...
    def example(self, header_param: Optional[str] = None, example_body: Optional[components.ExampleBody] = None) -> operations.ExampleResponse:
        ...
        if http_res.status_code >= 200 and http_res.status_code < 300:
            ...
            if utils.match_content_type(http_res.headers.get('Content-Type') or '', 'application/json'):                
                out = utils.unmarshal_json(http_res.text, errors.ExampleResponseBody)
            ...
            if utils.match_content_type(http_res.headers.get('Content-Type') or '', 'application/json'):                
                out = utils.unmarshal_json(http_res.text, errors.ExampleResponseResponseBody)
                out.raw_response = http_res
                raise out
            else:
                content_type = http_res.headers.get('Content-Type')
