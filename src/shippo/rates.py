...
class Rates:
    ...
    def get_rate(self, rate_id: str, shippo_api_version: Optional[str] = None) -> operations.GetRateResponse:
        ...
        res = operations.GetRateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_shipment_rates_by_currency_code(self, request: operations.ListShipmentRatesByCurrencyCodeRequest) -> operations.ListShipmentRatesByCurrencyCodeResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ListShipmentRatesByCurrencyCodeRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.ListShipmentRatesByCurrencyCodeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
