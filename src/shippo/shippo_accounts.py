...
class ShippoAccounts:
    ...
    def list_shippo_accounts(self, page: Optional[int] = None, results: Optional[int] = None, shippo_api_version: Optional[str] = None) -> operations.ListShippoAccountsResponse:
        ...
        query_params = utils.get_query_params(operations.ListShippoAccountsRequest, request)
        ...
        res = operations.ListShippoAccountsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_shippo_account(self, shippo_api_version: Optional[str] = None, base_shippo_account_struct: Optional[components.BaseShippoAccountStruct] = None) -> operations.CreateShippoAccountResponse:
        ...
        res = operations.CreateShippoAccountResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_shippo_account(self, shippo_account_id: str, shippo_api_version: Optional[str] = None) -> operations.GetShippoAccountResponse:
        ...
        res = operations.GetShippoAccountResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_shippo_account(self, shippo_account_id: str, shippo_api_version: Optional[str] = None, base_shippo_account_struct: Optional[components.BaseShippoAccountStruct] = None) -> operations.UpdateShippoAccountResponse:
        ...
        res = operations.UpdateShippoAccountResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
